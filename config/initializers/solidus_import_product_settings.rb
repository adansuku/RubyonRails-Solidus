...
Spree::ProductImport.settings = {
    ...
    :image_fields_products => [:image_product, :image_product_2, :image_product_3, :image_product_4, :image_product_5, :image_product_6, :image_product_7, :image_product_8, :image_product_9, :image_product_10, :image_product_11, :image_product_12], #Image fields that should be parsed for image locations of products
    :image_fields_variants => [:image_variant, :image_variant_2, :image_variant_3, :image_variant_4, :image_variant_5, :image_variant_6, :image_variant_7, :image_variant_8, :image_variant_9, :image_variant_10, :image_variant_11, :image_variant_12], #Image fields that should be parsed for image locations of variants
    :image_text_products => [:alt_product, :alt_product_2, :alt_product_3, :alt_product_4, :alt_product_5, :alt_product_6, :alt_product_7, :alt_product_8, :alt_product_9, :alt_product_10, :alt_product_11, :alt_product_12],  #Field that contains alt text for images of product.
    :image_text_variants => [:alt_variant, :alt_variant_2, :alt_variant_3, :alt_variant_4, :alt_variant_5, :alt_variant_6, :alt_variant_7, :alt_variant_8, :alt_variant_9, :alt_variant_10, :alt_variant_11, :alt_variant_12], #Field that contains alt text for images of variant.
