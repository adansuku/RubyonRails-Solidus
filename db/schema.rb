...
ActiveRecord::Schema.define(version: 20190227133604) do
  ...
  create_table "spree_addresses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string   "birth_day"
    t.string   "dni"
    t.boolean  "request_invoice",   default: false
  ...
  create_table "spree_adjustment_reasons", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
    t.string   "code"
  ...
  create_table "spree_assets_variants", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "image_id"
  ...
  create_table "spree_blog_entries", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "title"
    ...
    t.index ["author_id"], name: "index_spree_blog_entries_on_author_id", using: :btree
  end
  ...
  create_table "spree_cartons", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "number"
  ...
  create_table "spree_line_item_actions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_option_type_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_option_value_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_option_values_variants", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "variant_id"
  ...
  create_table "spree_order_mutexes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "order_id",   null: false
    t.datetime "created_at"
    t.index ["order_id"], name: "index_spree_order_mutexes_on_order_id", unique: true, using: :btree
  end

  create_table "spree_order_stock_locations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "order_id"
    t.integer  "variant_id"
    t.integer  "quantity"
    t.integer  "stock_location_id"
  ...
  create_table "spree_orders", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.date     "invoice_date"
    t.string   "locale"
    t.boolean  "sent_as_a_gift"
    t.string   "picked_store"
    t.text     "send_gift_text",         limit: 65535
  ...
  create_table "spree_orders_promotions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "order_id"
  ...
  create_table "spree_page_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["locale"], name: "index_spree_page_translations_on_locale", using: :btree
    t.index ["spree_page_id"], name: "index_spree_page_translations_on_spree_page_id", using: :btree
  end
  ...
  create_table "spree_pages_stores", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "store_id"
    t.integer  "page_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_paypal_express_checkouts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "token"
    t.string   "payer_id"
  ...
  create_table "spree_product_imports", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_product_property_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_product_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string   "slug"
    t.datetime "deleted_at"
    t.string   "composition_and_care"
    t.text     "featured_tag",         limit: 65535
  ...
  create_table "spree_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string   "meta_title"
    t.boolean  "extend_master_price",                default: true
    t.string   "composition_and_care"
  ...
  create_table "spree_promotion_codes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_promotion_rules_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.integer  "promotion_rule_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_promotion_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_promotions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.boolean  "active_solidus_sales",  default: true
  ...
  create_table "spree_property_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_relation_types", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
    t.text     "description", limit: 65535
    t.string   "applies_to"
    t.datetime "created_at"
  ...
  create_table "spree_relations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_return_reasons", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
    t.boolean  "active",     default: true
    t.boolean  "mutable",    default: true
    t.datetime "created_at"
  ...
  create_table "spree_rgpd_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "spree_rgpd_id",                null: false
    t.string   "locale",                       null: false
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
    ...
    t.string   "link_text"
    t.index ["locale"], name: "index_spree_rgpd_translations_on_locale", using: :btree
    t.index ["spree_rgpd_id"], name: "index_spree_rgpd_translations_on_spree_rgpd_id", using: :btree
  end

  create_table "spree_rgpds", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "link_to_terms_and_conditions"
    t.string   "terms_and_conditions_text"
    t.string   "accept_comunications_text"
    t.string   "link_text"
  ...
  create_table "spree_roles_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "role_id"
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_shipping_method_stock_locations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "shipping_method_id"
    t.integer  "stock_location_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_shipping_rate_taxes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_store_credit_update_reasons", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "spree_store_locator_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "spree_store_locator_id", null: false
    t.string   "locale",                 null: false
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.string   "address1"
    ...
    t.string   "state"
    t.string   "name"
    t.index ["locale"], name: "index_spree_store_locator_translations_on_locale", using: :btree
    t.index ["spree_store_locator_id"], name: "index_8c56d1c59ae21203b2815670e12700bf78ebb226", using: :btree
  end

  create_table "spree_store_locators", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "image_updated_at"
    t.integer  "position"
    t.index ["slug"], name: "index_spree_store_locators_on_slug", unique: true, using: :btree
  end

  create_table "spree_store_payment_methods", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_store_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_taxon_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_taxonomy_translations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_transfer_items", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "variant_id",                    null: false
  ...
  create_table "spree_unit_cancels", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_user_addresses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_user_stock_locations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.integer  "stock_location_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_variant_property_rule_conditions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "option_value_id"
  ...
  create_table "spree_variant_property_rule_values", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text     "value",                    limit: 65535
    t.integer  "position",                               default: 0
    t.integer  "property_id"
    t.integer  "variant_property_rule_id"
  ...
  create_table "spree_variant_property_rules", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "product_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_wished_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "variant_id"
  ...
  create_table "spree_wishlists", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.string   "name"
